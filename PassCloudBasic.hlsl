    ...
    if (_77_m50.z < _329)                //1600米 《= 对应的高度米
    {
                ...
                _489 = _490)
        {
            do
            {
                ...
                float _531 = max(0.0f, _511 - _528.z);
                ...
                bool _569 = _558 > 
                                (_77_m12.y * 
                                    min(
                                            ...
                                            1.0f - clamp(
                                                            _370 * 1.33333337306976318359375f, 
                                                            0.0f, 
                                                            1.0f)
                                        )
                                );
                ...
                {
                    float _583 = lerp(1.0f, _77_m40.w, clamp((_489 - _77_m12.w) / (1.0f - _77_m12.w), 0.0f, 1.0f));
                    float _586 = _475 * _583;
                    _469 = _468;
                    _472 = _583;
                    _474 = true;
                    _476 = _586;
                    ...
                    _482 = _481;
                    _484 = _483;
                    _488 = max(_77_m50.z + (_586 * _361), _487 - (_475 * (1.0f - _583)));
                    _490 = _489;
                    break;
                }


                float3 _597 = (_503 * asfloat(_29.Load3(380))) + asfloat(_29.Load3(392));
                float _598 = _503.z;
                float _632;
                if (true && (_598 < asfloat(_29.Load(376))))
                {
                    float3 _612 = (_503 * _77_m20.xyz) + _77_m21.xyz;
                    float _613 = _612.z;
                    float4 _621 = _79.SampleLevel(_74, float3(_597.xy, _613).xy, 0.0f);
                    float _629 = 1.0f - min(1.0f, abs((_613 - _621.x) / _621.y));
                    _632 = _621.z * (_629 * _629);
                }
                else
                {
                    _632 = 0.0f;
                ...
                if (_558 > 0.0f)
                {
                    ...
                    do
                    {
                        ...
                        float2 _657 = (_77_m52.yw * _531) + _77_m52.xz;
                        float _658 = _657.x;
                        _665 = _558 * clamp((_78.SampleLevel(_7, (_503 + _77_m39.xyz) * _77_m37.y, 0.0f).x - _658) / (_657.y - _658), 0.0f, 1.0f);
                        break;
                    } while(false);
                    float3 _672 = (_503 + _77_m38.xyz) * _77_m49.w;
                    float _704 = 1.0f - _78.SampleLevel(_7, ((_503 + (_77_m38.xyz * 1.5f)) * _77_m37.x) + ((((_80.SampleLevel(_7, _672.xy, 0.0f).xyz * 2.0f) - 1.0f.xxx) + ((_80.SampleLevel(_7, _672.xz, 0.0f).xyz * 2.0f) - 1.0f.xxx)) * (_77_m54.x + (_77_m54.y * _557))), 0.0f).x;
                    _715 = clamp((_665 - _704) / (((_77_m53.y * _557) + _77_m53.x) - _704), 0.0f, 1.0f);
                }
                else
                {
                    _715 = _558;
                }
                float _723 = 1.0f - clamp((_598 - _77_m40.x) * _77_m40.y, 0.0f, 1.0f);
                float _744;
                [branch]
                if (_77_m44.x > 0.0f)
                {
                    _744 = (1.0f - clamp(_531 * 10.0f, 0.0f, 1.0f)) * (_77_m44.x * clamp(_528.y - _77_m44.y, 0.0f, 1.0f));
                }
                else
                {
                    _744 = 0.0f;
                }
                float _748 = _715 + (((_632 + (((_723 * _723) * _723) * _77_m40.z)) + _744) * _77_m31[0].w);
                ...
                do
                {
                    ...
                    _799 = lerp(clamp(clamp((clamp(_68.SampleLevel(_6, _763, 1.0f).x / exp(asfloat(_29.Load(1760)) * _760.z), 0.0f, 1.0f) * (1.0f + _77_m44.z)) - _77_m44.z, 0.0f, 1.0f), 0.0f, 1.0f), asfloat(_29.Load(1792)), clamp((max(_766.x, _766.y) - 0.89999997615814208984375f) * 10.0f, 0.0f, 1.0f));
                    break;
                } while(false);
                float4 _806 = _75.SampleLevel(_74, _597.xy, 0.0f);
                float _807 = _806.y;
                float _833 = 1.0f - (sqrt(clamp((_502.z * _73_m0[3].x) + _73_m0[3].y, 0.0f, 1.0f)) * _77_m42.z);
                float _834 = _833 * _833;
                float _835 = (max(_77_m43.y, _799 * _799) * min(1.0f, clamp(((_597.z - _806.x) + (_807 * 0.25f)) / (_807 * 0.5f), 0.0f, 1.0f) + _77_m46.w)) * _834;
                float4 _1401;
                if (_748 > 0.0f)
                {
                    bool _852 = _715 > 0.0f;
                ...
                float _1405 = exp((-_748) * _475);
                float _1413 = _489 * _1405;
                float _1414 = _1413 * _1413;
                int _1431;
                if (true && (_479 == 0))
                {
                    _1431 = int(4.0f * (1.0f - (_487 / _77_m37.w)));
                }
                else
                {
                    _1431 = _477;
                }
                bool _1436 = ((!_569) && (_479 > 0)) && (!_473);
                float _1445;
                float _1446;
                if (_1436)
                {
                ...
                bool _1450 = (_569 && (_1447 > 0)) ? false : _473;
                float _1463;
                if (true && (!_1450))
                {
                ...
                _478 = _1431;
                _480 = _1447;
                _482 = lerp(_481, _487, _1414 * _1414);
                _484 = _483 + ((_835 * _475) * clamp((_1413 - 0.20000000298023223876953125f) * 1.25f, 0.0f, 1.0f));
                _488 = _1445 + _1463;
                _490 = _1413;
                break;
            } while(false);
